...
public class login extends javax.swing.JFrame {
    ...
    try {
            ...
            String sql = "SELECT * FROM pengguna where username='"+jTextField1.getText() 
            ...
            if (r.next()) {
                if(r.getString("level").equals("admin")){
                 ...
                 }else if(r.getString("level").equals("operator")){
                    JOptionPane.showMessageDialog(null,"Berhasil Login Operator");                    
                    this.setVisible(false);
